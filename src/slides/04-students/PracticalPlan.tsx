export default function PracticalPlan() {
  return (
    <>
      ...
      <p className="lede">
        План реальних <em>дій</em>. По одному завданню на місяць.
      </p>
      ...
      <div className="wide text-md" style={{ marginTop: '0.5em' }}>
        <ol style={{ textAlign: 'left', lineHeight: 1.6 }}>
          ...
          <li>
            <strong>Місяць 2.</strong> Обрати один домен, що вас цікавить (медицина, освіта, оборонка,
            енергія, geo). Прочитати 5 best-paper з останнього року.
          </li>
          <li>
          ...
          <li>
            <strong>Місяць 6.</strong> Зробити 50 цілеспрямованих контактів з меседжем

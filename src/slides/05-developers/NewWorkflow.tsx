...
export default function NewWorkflow() {
  ...
  return (
    <div ref={ref}>
      ...
      <p className="callout">
        Принцип: <strong>швидкість циклу</strong> важливіша за швидкість будь-якого кроку. Без checkpoint-ів
        ви отримуєте <em>повільний, зламаний</em> процес, відкритий для багатотижневих регресів.
      </p>
    </div>
  );
}
